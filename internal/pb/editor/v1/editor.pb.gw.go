...
func request_Editor_OpenProject_0(ctx context.Context, marshaler runtime.Marshaler, client EditorClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq OpenProjectRequest
...
func local_request_Editor_OpenProject_0(ctx context.Context, marshaler runtime.Marshaler, server EditorServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq OpenProjectRequest
		metadata runtime.ServerMetadata
	)
...
func RegisterEditorHandlerServer(ctx context.Context, mux *runtime.ServeMux, server EditorServer) error {
	mux.Handle(http.MethodPost, pattern_Editor_OpenProject_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_Editor_OpenProject_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_Editor_OpenProject_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	})
...
// "EditorClient" to call the correct interceptors. This client ignores the HTTP middlewares.
func RegisterEditorHandlerClient(ctx context.Context, mux *runtime.ServeMux, client EditorClient) error {
	mux.Handle(http.MethodPost, pattern_Editor_OpenProject_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Editor_OpenProject_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_Editor_OpenProject_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"editor", "v1", "OpenProject"}, ""))
)

var (
	forward_Editor_OpenProject_0 = runtime.ForwardResponseMessage
)
